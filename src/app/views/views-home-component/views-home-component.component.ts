...
export class ViewsHomeComponentComponent implements OnInit {
  ...
  items = [
    { image: '/assets/images/couch.jpeg', title: 'Couch', description: 'Homer Simpson would be proud' },
    { image: '/assets/images/dresser.jpeg', title: 'Dresser', description: 'Dressy Dress Dress' }
